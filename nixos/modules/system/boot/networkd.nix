  ...
  config = mkMerge [
    ...
    (mkIf config.systemd.network.enable {
      ...
      systemd.additionalUpstreamSystemUnits = [
        "systemd-networkd.socket" "systemd-networkd.service" "systemd-networkd-wait-online.service"
      ];
      ...
      # messages. Important to have systemd buffer those on behalf of networkd.
